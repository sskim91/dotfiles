...
| **맥락 보존** | 짧은 요약보다 나중에 다시 읽어도 이해되는 설명을 우선. 배경, 판단 근거, 예시를 생략하지 않는다 |
...
❌ 축약된 요약만 남기기 — 나중에 읽으면 "그래서 이게 왜 중요했지?"가 되는 노트
...
- "위키피디아랑 뭐가 다른가?"
- "내 판단과 분석이 들어가 있는가?"
- "3개월 뒤의 내가 이 노트만 읽고도 당시 맥락과 판단 근거를 복원할 수 있는가?"
- "짧아 보이게 만들려고 필요한 예시나 비교 기준을 지우지 않았는가?"
...
| **설명 밀도** | 핵심만 압축하지 않고 맥락, 판단 근거, 예시를 보존 | "나중에 읽어도 왜 이 노트를 만들었는지 알 수 있나?" |
