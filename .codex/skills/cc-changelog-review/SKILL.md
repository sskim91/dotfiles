...
description: Claude Code CLI 릴리스를 현재 dotfiles와 비교해 채택할 변경을 검토할 때 사용한다.
---
...
```bash
~/.dotfiles/.codex/skills/cc-changelog-review/scripts/fetch-changelog.sh        # last 5
~/.dotfiles/.codex/skills/cc-changelog-review/scripts/fetch-changelog.sh 10     # last N
~/.dotfiles/.codex/skills/cc-changelog-review/scripts/fetch-changelog.sh 2.1.128
~/.dotfiles/.codex/skills/cc-changelog-review/scripts/fetch-changelog.sh 2.1.120 2.1.128
~/.dotfiles/.codex/skills/cc-changelog-review/scripts/fetch-changelog.sh '#21128'
```
