...
description: Use when user says "project analysis", "프로젝트 분석", "onboarding", "codebase overview", "project overview", "이 프로젝트 뭐야". Do NOT use for session handoff (use session-handoff), learning summaries (use learning-tracker), or debugging.
---
