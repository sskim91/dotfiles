...
**어떻게 저장할까요?**
- TIL 문서 (~/dev/TIL) - 장기 참조용 상세 문서
- 플래시카드 (Obsidian) - 암기/복습용 Q&A 카드
- 둘 다 생성
```
...
학습 내용 추출 후 목적에 맞는 스킬 호출:

| 목적 | 스킬 | 결과물 |
|------|------|--------|
| 장기 참조 문서 | `/til` | `~/dev/TIL/{category}/` |
| 암기/복습 카드 | `/obsidian-flashcard` | Obsidian `00.Inbox/FC-*.md` |

```
/learning-tracker → 학습 추출 → TIL 또는 플래시카드 선택
```
