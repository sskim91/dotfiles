---
name: find-docs
description: Use when looking up API references, library documentation, CLI commands, or checking version-specific behavior for any developer technology. Prefer this when documentation accuracy matters or model knowledge may be outdated.
---
