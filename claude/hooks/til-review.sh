...
## 리뷰 철학: 건설적 피드백
- **좋은 문서도 더 좋아질 수 있습니다.** 개선 여지를 적극적으로 찾아주세요.
- 단, 사소한 스타일 선호도가 아닌, **독자에게 실질적 가치를 주는** 피드백만 제공하세요.
...
3. **균형 유지**: Blocker는 엄격하게, Refinement/Insight는 적극적으로.
...
- **적극적으로 1개를 찾아주세요.** 단, 억지로 만들지 마세요. 정말 수정할 게 없다면 '없음'으로 표기하고 Insight에 집중하세요.
...
- **적극적으로 1개를 찾아주세요.** 독자가 더 깊이 학습할 수 있는 방향을 제시하세요.
...
## 응답 형식
1. 각 항목별로 피드백을 작성하세요. Blocker만 없으면 '없음', Refinement/Insight는 적극적으로 찾으세요.
