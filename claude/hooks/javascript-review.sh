...
**0. ANTI-HALLUCINATION (CRITICAL - READ FIRST):**
   - **NEVER report whitespace/spacing issues** in import paths, strings, or module names (e.g., DO NOT say \"there's a space in '@vitejs/...'\" or \"' @testing-library/...'\" - this is hallucination).
