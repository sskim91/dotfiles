...
# ----------------------------------------------------------------------------
# Commit 보안 게이트 (pre-commit-gate.sh — Claude; Codex는 .codex/config/hook-settings.sh)
# ----------------------------------------------------------------------------
...
# ----------------------------------------------------------------------------
# 모델별 프롬프팅 지침 주입 (model-context.sh — SessionStart/PostModelSwitch)
# ----------------------------------------------------------------------------
export ENABLE_MODEL_CONTEXT=1        # Opus 5 세션에 간결성·위임 제한 지침 주입 (Fable은 하네스가 자체 주입)
